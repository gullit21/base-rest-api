...
import com.br.baserestapi.config.token.CustomTokenEnhancer;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		clients.inMemory()
				.withClient("angular")
				.secret("$2a$10$yM1Pm7n2zOIk0E4dxVVhm.Spqz9l9LYcqPp1msb1Cu0KqV8/PFBOe") // @ngul@r0
				.scopes("read", "write")
			...
			.and()
			.withClient("mobile")
			.secret("$2a$10$UlVVDsKbDcEZpWFcENkWJu8OqIG0VDW/LtF.bAtKKC5wnxtBTEkqi") // m0b1l3
			.scopes("read")
			.authorizedGrantTypes("password", "refresh_token")
			.accessTokenValiditySeconds(1800)
